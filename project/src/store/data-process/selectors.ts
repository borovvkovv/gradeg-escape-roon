...
export const getIsQuestsLoading = (state: State) => state[NameSpace.Data].isQuestsLoading;
export const getIsQuestLoading = (state: State) =>
  state[NameSpace.Data].isQuestLoading;
export const getBookingInfoList = (state: State) => state[NameSpace.Data].bookingInfoList;
